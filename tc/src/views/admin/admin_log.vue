      ...
      <div class="row">
        <div class="text-center col-7 ml-auto mr-auto">
          <div class="login_reg_head d-flex justify-content-center">
            <span class="text-dark font-weight-bold h3">管理员登录</span>
          </div>
          <div class="my-5">
            <div class="tab_login">
              <div class="login_form text-left">
                <div>
                  ...
                  <!-- 登录码输入框 -->
                  <el-input prefix-icon="el-icon-star-on" type="password" placeholder="管理员登录码" class="w-100 mt-4" v-model="acode" @keyup.13.native="alog"></el-input>
