          ...
          <div class="my-5">
            <div class="tab_login">
              <div class="login_form">
                <div>
                  <el-input prefix-icon="el-icon-s-custom" placeholder="用户名" class="mb-4" v-model="uname"></el-input>
    ...
    <el-dialog
      ...
      <el-form :model="updateForm" status-icon :rules="rules" ref="updateForm">
        <el-form-item prop="stuNum">
          <el-input placeholder="请输入手机号" prefix-icon="el-icon-s-custom" v-model="updateForm.phone"></el-input>
        </el-form-item>
...
export default {
  ...
  methods:{
    ...
    log(){
      ...
      this.axios.post("/user/u1/login",this.qs.stringify(object)).then(res => {
        //将返回结果赋值给res
        this.res=res.data
        //如果登录失败，修改弹窗的值，显示弹窗
        if(this.res==0){
